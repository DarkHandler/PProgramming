...
int main(int argc, char *argv[])
{
	...
	if(rankID == 0){
		...
		std::cout << T.elapsed() << "> " << rankID << ": datos creados" << std::endl; //Comentar para realizar experimento
		...
		//std::cout << tiempoSecuencial << std::endl; //Descomentar para realizar experimento
		std::cout << T.elapsed() << "> " << rankID << ": Suma secuencial: " << sumaSecuencial << std::endl; //Comentar para realizar experimento
		std::cout << T.elapsed() << "> " << rankID << ": Tiempo secuencial: " << tiempoSecuencial << std::endl; //Comentar para realizar experimento
	}
	...
	//Cada proceso realiza su suma parcial
	...
	mpi::reduce(world, sumaParcial, sumaParalela, std::plus<double>(), senderRank);
	...
	if(world.rank() == 0) {
		...
		//std::cout << tiempoParalelo << std::endl; //Descomentar para realizar experiemnto
		std::cout  << T.elapsed() << ">" << rankID << ": Suma Paralela:" << sumaParalela << std::endl; //Comentar para realizar experimento
		std::cout << T.elapsed() << "> " << rankID << ": Tiempo paralelo: " << tiempoParalelo << std::endl; //Comentar para realizar experimento
	}
